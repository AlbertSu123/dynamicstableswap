...
export async function getMulticallProvider(
  ...
  } else if (chainId === ChainId.EVMOS_TESTNET) {
    ethcallProvider.multicall3 = {
      address: "0xdA65b5C7d36CA36CC4A6d1bcAE9AFb95a7c31032",
      block: 0,
    }
    ethcallProvider.multicall2 = {
      address: "0xbC314d62E04cE82F3147d03728c8700824595819",
      block: 0,
    }
    ethcallProvider.multicall = {
      address: "0x4a686ddd8daDC292ABCc6E6309303BC43D3E01DF",
      block: 0,
    }
  }
...
export function getTokenIconPath(tokenSymbol: string): string {
  ...
  return pngSet.has(tokenSymbol)
    ? `/static/icons/png/${iconName}.png`
    : `/static/icons/svg/${iconName}.svg`
}
